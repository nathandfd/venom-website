    ...
    return(
            <div className="reading-menu-container">
                <div className={"reading-menu"}>
                    <div className={"close"} onClick={()=>{setVisibility(false)}} onMouseEnter={cursorRef.current?()=>{handleMouseEnter()}:null} onMouseLeave={cursorRef.current?()=>{handleMouseLeave()}:null}>
